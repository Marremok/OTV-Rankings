...
import { SeriesStatusDropdown } from "./SeriesStatusDropdown";
    ...
    <section className="relative h-[90vh] w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-6 left-6 right-6 z-30 flex items-center justify-between">
        ...
        <Link
          ...
          className="group flex items-center gap-2.5 bg-black/30 backdrop-blur-md px-5 py-2.5 rounded-full border border-white/10 transition-all duration-300 hover:bg-black/50 hover:border-white/20 hover:scale-105"
        >
