...
export function SeasonDescriptionSection({ title, description, score, ranking }: SeasonDescriptionSectionProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-start">
          ...
          <div className="lg:col-span-8 flex flex-col justify-center">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-zinc-400 font-light">
              {description || "No description available for this season yet."}
            </p>
