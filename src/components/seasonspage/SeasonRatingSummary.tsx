...
import { useGetSeasonPillarScores } from "@/hooks/use-pillars";
...
export function SeasonRatingSummary({ slug }: SeasonRatingSummaryProps) {
  const { data, isLoading } = useGetSeasonPillarScores(slug);
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-4 py-8">
            ...
            <p className="text-zinc-500 max-w-md text-center text-sm">
              No community ratings yet. Rate this season below to be the first!
            </p>
          </div>
        </div>
      </section>
