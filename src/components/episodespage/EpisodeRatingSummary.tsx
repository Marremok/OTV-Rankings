...
import { useGetEpisodePillarScores } from "@/hooks/use-pillars";
...
export function EpisodeRatingSummary({ slug }: EpisodeRatingSummaryProps) {
  const { data, isLoading } = useGetEpisodePillarScores(slug);
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-xs font-bold text-primary uppercase tracking-[0.3em]">Community Scores</span>
          ...
          <div className="flex flex-col items-center gap-4 py-8">
            ...
            <p className="text-zinc-500 max-w-md text-center text-sm">
              No community ratings yet. Rate this episode below to be the first!
            </p>
          </div>
        </div>
      </section>
