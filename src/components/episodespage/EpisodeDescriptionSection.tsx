...
export function EpisodeDescriptionSection({ title, description, score, ranking }: EpisodeDescriptionSectionProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 items-start">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-zinc-900/70 backdrop-blur-xl border border-zinc-800/80 rounded-3xl p-5 md:p-8 text-center overflow-hidden">
                ...
                <div className="relative mb-2">
                  <span className={cn("text-5xl md:text-7xl font-black tabular-nums tracking-tight", scoreColor)}>
                    {score.toFixed(2)}
                  </span>
                </div>
                ...
                {ranking && ranking > 0 && (
                  <div className="flex items-center justify-center gap-2 text-zinc-400">
                    ...
                    <span className="text-sm font-medium">Ranked #{ranking} overall</span>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="lg:col-span-8 flex flex-col justify-center">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-zinc-400 font-light">
              {description || "No description available for this episode yet."}
            </p>
